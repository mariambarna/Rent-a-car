...
<div class="p-5">
    <table class="table table-sm table-striped">
        ...
        <?php
        $sql = "SELECT * FROM rentinfo WHERE Status = 'Pending' OR Status = 'Started' ORDER BY SerialNo DESC";
        ...
        foreach($res as $row){
            ...
            <tr>
                ...
                ?>
                <a href="updateride.php?startid=<?php echo $row['SerialNo'] ?>" class="btn btn-sm btn-success m-1">Start</a> <a href="updateride.php?cancelid=<?php echo $row['SerialNo'] ?>" class="btn btn-sm btn-danger">Cancel</a>
                <?php
